...
基于《Political Animal》v0.1 设计文档开发的 Stage 3 浏览器原型。现有两个可完整游玩的独立剧本：“狐狸共和国：伟大的教育改革”与“企鹅海峡危机”。
...
- Scenario Registry / Loader 同时注册两个剧本，主菜单可选择剧本和玩家身份
...
- Vitest 单元测试、两个剧本各 10,000 局无死路模拟、GitHub Actions CI
...
Stage 3 用第二题材验证现有引擎的可复用性；未增加地图、军事或外交数值模拟，也不使用实时 AI。
